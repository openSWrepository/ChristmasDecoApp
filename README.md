...
2. 루트 디렉토리에서 docker-compose 빌드
    ...
    - 프로젝트 디렉토리로 이동 후:
      ```bash
      npm install
      npm install react-icons react-particles
      ```

3. 로컬 ChristmasDecoApp
...
1. 백엔드 클론
    ...
    ```bash
    git clone https://github.com/openSWrepository/logic.git
    ```
    
2. 프로젝트 빌드
    - 클론한 프로젝트 폴더 내의 `build.gradlew` 실행
    
3. 실행
    - `LogicApplication.java` 실행
    - 경로: `src/main/java/_1/logic/LogicApplication.java`
